...
<?php 
	...
	if(!isset($_POST["accion"]))
	{
		...
		elseif($_POST["accion"]=="Editar Noticia") //cuando ya se tienen los datos
		{
                ...
                <div class="panel panel-success">
                  ...
                  <div class="panel-body">
                      ...
                      <div class="form-group">
                          <label>Título</label>
                          <input name="titulo" id="titulo" class="form-control" <?php echo "value='".$intervencion[3]."'"; ?>>
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group">
                            <label>Fecha</label>
                           <input name="fecha" id="fecha" type="date" class="form-control" placeholder="AAAA-MM-DD" <?php echo "value='".$intervencion[1]."'"; ?> >
                            <p class="help-block"></p>
                          </div>
                        </div>
                        <div class="col-md-6"> 
                      ...
                      <div class="form-group">
                        <label>Resumen</label>
                        <textarea name="resumen" id="resumen" class="form-control" rows="3"><?php echo $intervencion[4]; ?></textarea>
                      </div>    
                      <div class="row">
                        <div class="col-md-4"> 
                          <div class="form-group">
                        ...
                        <div class="col-md-2">
                          <div class="form-group">
                            <label>Página</label>
                            <input name="pagina" id="pagina" class="form-control" <?php echo "value='".$intervencion[8]."'"; ?>>
                            <p class="help-block"></p>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group">
                            <label>Link</label>
                            <input name="link" id="link" class="form-control" <?php echo "value='".$intervencion[9]."'"; ?>>
                            <p class="help-block"></p>
                          </div>
                        </div>
                      </div>
