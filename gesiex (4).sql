...
--
-- Servidor: localhost
-- Tiempo de generación: 24-08-2018 a las 16:27:05
...
INSERT INTO `intervencion` (`id_intervencion`, `fecha`, `lugar`, `titulo`, `resumen`, `delito`, `interventor`, `fuente`, `pagina`, `link`, `eliminado`) VALUES
(97, '2018-03-28', 1, 'Decretan expulsar del país a hombre condenado por tráfico de drogas', 'El tribunal de Juicio Oral en lo Penal de Arica condenó a Luis Antonio Inca Guerrero a la pena de 5 ańos de presidio en calidad de autor del delíto de tráfico de drogas. Ilícito perpetrado en mayo pasado en el complejo fronterizo de Chacalluta.  Asimismo decretaron la expulsión del pais para el ciudadano colombiano que no podrá reingresar a Chile por el término de 10 ańos. Luis Inca fue intervenido el 6 de mayo del 2017 cuando pasaba el control manejando un vehículo,  se reviso el auto por advertencia del perro detector de drogas. Tras la revisión se encontró  39 kilos de cannabis y  4 kilos de cocaína. ', 8, 1, 1, '0', '0', 0),
...
(396, '2018-08-11', 1, 'CCL: Arancel de 10% a productos de Colombia puede generar subida de precios', 'Resumen', 8, 1, 1, '0', '0', 0),
...
(411, '2018-08-20', 11, 'Baño de un bus iba pasando marihuana cripy', 'El Ministerio de Agricultura y Riego a través del Servicio Nacional de Sanidad Agraria(Senasa) certificó  toneladas de palta fuerte para su exportación a Chile en la planta empacadora Guadalcazar S.A. ubicada en el centro poblado Los Ángeles del distrito de Moquegua. Durante inspección, el especialista del Senasa certificó el cumplimiento de los requisitos fitosanitarios del producto que establece el país importador, el correcto embalaje de las cajas de primer uso, con código de lugar de producción, empacadores, departamento, productor y campańa. Además cada palta cuenta con una etiqueta autoadhesiva donde indica el código de la empacadora y la leyenda Producto del Perú. Este producto proviene de las zonas de producción de Omate en Moquegua y Locumba en Tacna, las cuales son certificadas previamente por la autoridad agraria.  ', 2, 5, 4, '0', '0', 0),
(412, '2018-08-23', 1, 'Licores ilegales por 1.5 millones de soles llevaban a Lima en cajas de manzana', 'Agentes de la Policía Fiscal de Lima el martes 21 en el kilómetro 48 de la Vía Panamericana Sur incautaron un camión procedente de Tacna con  licores de contrabando por un millón y medio de soles. Los productos consistían en botellas de whisky, tequila y otros que estaban camuflados en 10 cajas de manzana importadas, siendo capturados en flagrancia, Celso Choquecota e Isidora Cachicatari Flores. El Coronel de la PNP Segundo Mejía, director de la Policía Fiscal, señaló que los productos fueron importados por la Zona Franca de Tacna, ya que las botellas tenían el sticker o sello de ingreso, mediante los cuales se podrá identificar al o los propietarios de la mercancía.', 1, 7, 1, '6', 'http://ediciondigital.diariocorreo.pe/tacna/20180823', 0);
...
--
ALTER TABLE `delito`
MODIFY `id_delito` int(10) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=9;
--
...
--
ALTER TABLE `encuesta`
MODIFY `cod` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=198;
--
...
--
ALTER TABLE `intervencion`
MODIFY `id_intervencion` int(15) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=413;
--
